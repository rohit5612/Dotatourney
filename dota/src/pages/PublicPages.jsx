...
export function TournamentInfo({ message }) {
  return (
    <div className="tournament-maintenance">
      {message ? (
        <p className="mx-auto mb-4 max-w-3xl rounded-md border border-border bg-card/90 p-2 text-sm text-secondary shadow-sm backdrop-blur-sm">
          {message}
        </p>
      ) : null}
      <section className="tournament-maintenance__hero" aria-labelledby="tournament-maintenance-title">
        <img className="tournament-maintenance__bg" src="/images/tournamenthero.jpg" alt="" aria-hidden="true" />
        <div className="tournament-maintenance__overlay" aria-hidden="true" />
        <div className="tournament-maintenance__inner">
          <p className="tournament-maintenance__eyebrow">Tournament hub</p>
          <h1 id="tournament-maintenance-title" className="tournament-maintenance__title">
            Under maintenance
          </h1>
          <p className="tournament-maintenance__lead">
            We&apos;re rebuilding this page with a fresh tournament experience. Check back soon — bracket, schedule, and
            teams are still available from the main menu.
          </p>
        </div>
      </section>
    </div>
