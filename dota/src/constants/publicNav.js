...
/** Set true to expose `/announcements` (News page). Admin + banner announcements stay active either way. */
export const ANNOUNCEMENTS_PUBLIC = false;
...
export const PUBLIC_NAV_LINKS = [
  ...
  { href: "/announcements", label: "News", showWhen: "announcementsPublic" },
