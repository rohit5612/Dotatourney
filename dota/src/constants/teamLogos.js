/** Static team logos under /public/images/teams/ — add files + entries here when new teams join. */
...
export const TEAM_LOGO_URLS = TEAM_LOGO_CATALOG.map((entry) => entry.url);
